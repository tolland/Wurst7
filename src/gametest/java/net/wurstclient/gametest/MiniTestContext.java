...
public class MiniTestContext implements AutoCloseable {
     ...
     */
    private void setup() {
        WurstTest.LOGGER.info("Setting up test area at ({}, {}, {})", location.baseX,
                location.baseY, location.baseZ);
     ...
     * @param dy      relative Y offset
     * @param dz      relative Z offset
     * @param blockId the block ID with optional state (e.g., "minecraft:carrots[age=7]")
     */
     ...
     * columns are X coordinates. The player is always at the center of the array.
     * <p>
     * Requirements:
     ...
     * setBlockLayer(
     *      -1,
     *      MiniTestContext.createCommonBlockDict(),
     *      new String[][]{
     *          {"stone", "stone", "stone"},
     *          {"stone", "stone", "stone"},
     *          {"stone", "stone", "stone"},
     ...
     * }</pre>
     *
     * @param y         the Y level (relative to test location)
     * @param blockDict map of block aliases to block IDs (e.g., "stone" -> "minecraft:stone")
     * @param layer     2D array where each cell is either null, "player", or a block alias
     *                  from blockDict. Rows represent Z coordinates, columns represent X
    ...
    /**
     * Teleports the player to a specific position relative to the test location.
     *
     * @param dx    relative X offset
     * @param dy    relative Y offset
     * @param dz    relative Z offset
