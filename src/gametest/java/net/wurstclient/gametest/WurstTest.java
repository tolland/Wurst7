...
public class WurstTest implements FabricClientGameTest {
    ...
    private void testInWorld(ClientGameTestContext context,
        ...
        for (String block : List.of("minecraft:lectern",
                "minecraft:smooth_stone", "minecraft:carved_pumpkin",
                "minecraft:comparator", "minecraft:white_bed",
                "minecraft:shulker_box", "minecraft:chest",
                "minecraft:crafting_table", "minecraft:beacon",
                "minecraft:ender_chest", "minecraft:loom",
